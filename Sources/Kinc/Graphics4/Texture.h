...
Kinc_G4_Texture *Kinc_G4_Texture_Create(int width, int height, Kinc_ImageFormat format, bool readable);
Kinc_G4_Texture *Kinc_G4_Texture_Create3D(int width, int height, int depth, Kinc_ImageFormat format, bool readable);
