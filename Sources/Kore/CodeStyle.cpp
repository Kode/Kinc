...
public:              // public on top
	...
	// lower camel case for parameters and
	// locals, camel case is used for
	// akronyms, too
	virtual void playSfx(int soundId) {}
...
public:
	// use the C++0x nullptr keyword - already
	// supported in VS2010, defined to NULL for all
	// other compilers
	StyleExample2() : myExample(nullptr) {}

	// use the C++0x override keyword - already
	// supported in VS2010, defined to nothing
	// for all other compilers
	virtual void playSfx(int soundId) override {}
