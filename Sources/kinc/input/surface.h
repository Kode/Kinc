...
KINC_FUNC void kinc_set_surface_touch_start_callback(void (*value)(int /*index*/, int /*x*/, int /*y*/));

/// <summary>
/// Sets the surface-move-callback which is called when a finger is moving around.
/// </summary>
/// <param name="value">The callback</param>
KINC_FUNC void kinc_set_surface_move_callback(void (*value)(int /*index*/, int /*x*/, int /*y*/));

/// <summary>
/// Sets the surface-touch-end-callback which is called when a finger disappears. This is usually not a medical emergency.
/// </summary>
/// <param name="value">The callback</param>
KINC_FUNC void kinc_set_surface_touch_end_callback(void (*value)(int /*index*/, int /*x*/, int /*y*/));
