...
extern void (*Kinc_Keyboard_KeyDownCallback)(int /*key_code*/);
extern void (*Kinc_Keyboard_KeyUpCallback)(int /*key_code*/);
extern void (*Kinc_Keyboard_KeyPressCallback)(unsigned /*character*/);
