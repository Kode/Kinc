...
void Kore::Windows::affirm(HRESULT result) {
	if (result != S_OK) {
		winerror(result);
	}
}

void Kore::Windows::affirm(HRESULT result, const char* format, ...) {
	va_list args;
...
void Kore::Windows::format(const char* format, va_list args, wchar_t* buffer) {
