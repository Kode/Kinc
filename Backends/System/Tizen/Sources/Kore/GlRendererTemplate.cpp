...
bool GlRendererTemplate::TerminateGl(void) {
	// TODO:
	// Terminate and reset GL status.
	return true;
}

bool GlRendererTemplate::Draw(void) {
	Kore::Application::the()->callback();
	return true;
}

bool GlRendererTemplate::Pause(void) {
	// TODO:
...
bool GlRendererTemplate::Resume(void) {
	// TODO:
...
int GlRendererTemplate::GetTargetControlWidth(void) {
	// TODO:
...
int GlRendererTemplate::GetTargetControlHeight(void) {
	// TODO:
...
void GlRendererTemplate::SetTargetControlWidth(int width) {
	// TODO:
...
void GlRendererTemplate::SetTargetControlHeight(int height) {
	// TODO:
