...
void kope_webgpu_compute_pipeline_init(kope_webgpu_device *device, kope_webgpu_compute_pipeline *pipe, const kope_webgpu_compute_pipeline_parameters *parameters);
