...
VkBuffer *kinc_vulkan_internal_vertexUniformBuffer = NULL;
VkBuffer *kinc_vulkan_internal_fragmentUniformBuffer = NULL;
...
void kinc_g5_constant_buffer_init(kinc_g5_constant_buffer_t *buffer, int size) {
	...
	if (kinc_vulkan_internal_vertexUniformBuffer == NULL) {
		kinc_vulkan_internal_vertexUniformBuffer = &buffer->impl.buf;
	}
	else if (kinc_vulkan_internal_fragmentUniformBuffer == NULL) {
		kinc_vulkan_internal_fragmentUniformBuffer = &buffer->impl.buf;
	}
