...
function ClCompile(out, indentation, platform, configuration, includes, defines) {
	Block.call(this, out, indentation);
...
ClCompile.prototype = Object.create(Block.prototype);
ClCompile.constructor = ClCompile;
...
ClCompile.prototype.print = function () {
	var defineLine = toLine(this.defines);
	var includeLine = toLine(this.includes);
